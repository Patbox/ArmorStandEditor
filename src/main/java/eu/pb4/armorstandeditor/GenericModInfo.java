...
public class GenericModInfo {
    ...
    public static void build(ModContainer container) {
...

        {
            ...
            try {
                about.add(Component.literal(container.getMetadata().getName()).setStyle(Style.EMPTY.withColor(0xffcc00).withBold(true).withClickEvent(new ClickEvent.OpenUrl(URI.create(container.getMetadata().getContact().get("github").orElse("https://pb4.eu"))))));
                about.add(Component.translatable("text.armor_stand_editor.about.version",
                        Component.literal(container.getMetadata().getVersion().getFriendlyString()).setStyle(Style.EMPTY.withColor(ChatFormatting.WHITE))).setStyle(Style.EMPTY.withColor(0xf7e1a7)));
                ...
                about.add(Component.literal("")
                        .append(Component.translatable("text.armor_stand_editor.about.contributors")
