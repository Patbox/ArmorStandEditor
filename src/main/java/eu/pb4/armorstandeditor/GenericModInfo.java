...
public class GenericModInfo {
    ...
    public static void build(ModContainer container) {
...

        {
            ...
            try {
                about.add(new LiteralText(container.getMetadata().getName()).setStyle(Style.EMPTY.withColor(0xffcc00).withBold(true).withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL,container.getMetadata().getContact().get("github").orElse("")))));
                about.add(new TranslatableText("text.armor_stand_editor.about.version").setStyle(Style.EMPTY.withColor(0xf7e1a7))
                ...
                about.add(new LiteralText("")
                        .append(new TranslatableText("text.armor_stand_editor.about.contributors")
